...
//		Step 05
		...
		for (String w : allWin) {
			if (!parentId.equals(w)) {
				...
				WebElement addtoCarrt = driver.findElement(By.xpath("//input[@id='add-to-cart-button']"));
				JavascriptExecutor js = (JavascriptExecutor) driver;
				js.executeScript("arguments[0].scrollIntoView(true)", addtoCarrt);
				js.executeScript("arguments[0].click()", addtoCarrt);
				break;
			}
		}
