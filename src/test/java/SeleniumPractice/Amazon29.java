...
//		Step 04
		...
		String expectedProduct = "iPhone 17 Pro Max 1 TB: 17.42 cm (6.9″) Display with Promotion, A19 Pro Chip, Best Battery Life in Any iPhone Ever, Pro Fusion Camera System, Center Stage Front Camera; Cosmic Orange";
...
//		Step 06
		File scrennShot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		File destination = new File("image.jpg");
		FileUtils.copyFile(scrennShot, destination);
