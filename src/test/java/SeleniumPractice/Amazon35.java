...
//		Step 06
		...
		File destiantion = new File("imagetyu.jpg");
		try {
			FileUtils.copyFile(screnShot, destiantion);
		} catch (IOException e) {
			e.printStackTrace();
		}
